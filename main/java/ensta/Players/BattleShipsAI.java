    ...
    public void putShips(AbstractShip ships[]) {
        ...
        for (AbstractShip s : ships) {
            do {
                ...
                List<AbstractShip.Orientation> orList = Arrays.asList(orientations);
                o = orList.get(rnd.nextInt(orList.size()));
                s.setOrientation(o);

                x = rnd.nextInt((max - min) ) + min;
                y = rnd.nextInt((max - min) ) + min;
